...
# Short bio
I come from a beautiful eastern Europe country Moldova, where I finished my licence in **software engineering**.

{% include figure image_path="/assets/img/moldova_image.jpg" alt="Orheiul Vechi" caption="This is one of my favorite places in Moldova. It's name is 'Orheiul Vechi', in english 'Old Orhei'. This is is a natural and historical complex. It is places around 50km of the capital of Moldova (Chisinau). I strongly recomand you to visit this place if you are going to visit Moldova.  " %}

By the end, I got experience in developing desktop and web applications. I was very passionate but I decided to move to France. Here, I obtained a master degree in Computer Science, that is in **Data mining and exploration EID2**, at University Paris 13 and than a **Ph.D** in **Statistical Learning** at University of Toulon. At the end, I had different opportunities to gain experience in academic and company environments. Today, I am working on the 11 projects proposed by the Open Classroom course for the **Data Scientist : Artificial Intelligence Engineer** in order to improve some of my skills.
...
Currently I’m a student at OpenClassroom as an Engineer in Artificial Intelligence. I'm working on 11 projects that includes Data Analysis and Exploration, Data pre-processing, Supervised and Non-supervised modeling, Deep Learning, NLP, Cloud Computing, Visualization, Model Deployment. [Here](https://openclassrooms.com/fr/paths/188-ingenieur-ia) you can read the full description for this online learning path.
